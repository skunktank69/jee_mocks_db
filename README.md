...
## JSON
```url
  https://raw.githubusercontent.com/skunktank69/jee_mocks_db/refs/heads/master/mocks_jsonl/{subject}/{chapter}.jsonl
```
...
the pathmap for all subjects in json format is now available in 
```url
  /mocks_jsonl/index.json
```
